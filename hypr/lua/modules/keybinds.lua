...
plugin.setup = function(config)
    ...
    hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(config.programs.terminal))
    hl.bind(mainMod .. " + F", hl.dsp.exec_cmd(config.programs.file_manager))
    hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(config.programs.browser))
    hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(config.programs.music_player))
    hl.bind(mainMod .. " + G", hl.dsp.exec_cmd(config.programs.game_launcher))
    hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(config.programs.social_chat))
    hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(config.programs.note_taker))
